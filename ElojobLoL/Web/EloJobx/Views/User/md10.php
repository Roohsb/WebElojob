   ...
   exit;
    ...
    if (!in_array(strtolower($EloTools->tirarAcentos($_POST["temporada"])) , EloTools::ELO_NAME, true) || !in_array($_POST["fila"], EloTools::ROUTES, true) || !in_array($_POST["modo"], EloTools::MODES, true))
    {
     ...
     exit;
      ...
      $Resultado = $EloTools->SeachBest10($_POST["temporada"],$_POST["modo"],$_POST["fila"],$_POST["quantidade"],1);
      if($Resultado == '{"status":false, "Mensagem": "Servico nao encontrado"}'){
         header("Location: /saguao");
         exit;
      }
      $Valor = $Resultado[$_POST["modo"]]["Fila"][$_POST["fila"]]["Price"] * $_POST["quantidade"];

      if(!isset($_SESSION["MDPrice"]) || $_SESSION["MDPrice"] != $Valor || $_SESSION["MDModo"] != $_POST["modo"]){
         $_SESSION["MDPrice"] =       $Valor;
         $_SESSION["MDQuantidade"] =  $_POST["quantidade"];
         $_SESSION["MDModo"] =        $_POST["modo"];
         $_SESSION["MDFila"] =        $_POST["fila"];
         $_SESSION["MDTemporada"] =   $_POST["temporada"];
      }
}

if($_SERVER["REQUEST_METHOD"] != "POST"){ 
   if(!isset($_SESSION["MD10Alert"]) OR (!isset($_SESSION["MDPrice"]))){
      header("Location: /saguao");
      exit;
   }
}
...
echo '<!DOCTYPE html>
   <html class="no-js" lang="pt">
      <head>
         <meta charset="utf-8">
         <title>LorenJob - Comprar > Melhor de 10</title>
         ...
         <script src="https://elojobhigh.com.br/app/assets/js/vendor/modernizr.min.js" type="ccb2ed1d7e003390d40b98f8-text/javascript"></script>
         <style type="text/css">
      ...
      <body>
      <script>var total = '. $_SESSION["MDPrice"].';</script>
                  ...
                  echo '<div id="page-content">
                     <div class="block">
                        <div class="block-title">
                           <h3>Serviço <strong>Melhor de 10</strong></h3>
                        </div>
                        <form action="/api/purchase-md10" method="post" class="form-horizontal form-bordered">
                           <div class="form-group">
                              <div class="col-md-12">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       ...
                                       <select name="modo" id="modo" disabled="disabled" class="form-control">
                                          <option value="'.$_SESSION["MDModo"].'" selected="selected">'.ucwords($_SESSION["MDModo"]).'</option>
                                       </select>
                                    </div>
                                    <div class="form-group">
                                       <label for="fila">Fila desejada</label>
                                       <select name="fila" id="fila" disabled="disabled" class="form-control">
                                          <option value="'.$_SESSION["MDFila"].'" selected="selected">'.ucwords($_SESSION["MDFila"]).'</option>
                                       </select>
                                    </div>
                                    <div class="form-group">
                                       <label for="quantidade">Jogos desejados</label>
                                       <select name="quantidade" id="quantidade" disabled="disabled" class="form-control">
                                          <option value="'.$_SESSION["MDQuantidade"].'" selected="selected">'.$_SESSION["MDQuantidade"].'</option>
                                       </select>
                                    </div>
                                 </div>
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       <label for="temporada">Liga anterior</label>
                                       <select name="temporada" id="temporada" disabled="disabled" class="form-control">
                                          <option value="'.$_SESSION["MDTemporada"].'" selected="selected">'.ucwords($_SESSION["MDTemporada"]).'</option>
                                       </select>
                                    </div>'; 
                                    if (!in_array(strtolower($EloTools->tirarAcentos($_SESSION["MDTemporada"])) , EloTools::DONT_HAVE_DIVISIONS, true))
                                    {
                                      echo '<div class="form-group">
                                       <label for="divisao">Divisão anterior</label>
                                       <select name="divisao" id="divisao" class="form-control">
                                    ...
                                    echo '
                                    <div class="form-group">
                                       <label for="prazo">Prazo de início</label>
                                       <input type="text" name="prazo" value="Até '.$_SESSION["MDQuantidade"].' dias" disabled="disabled" id="prazo" class="form-control" placeholder="Prazo">
                                       <span class="help-block">Normalmente os booster começam bem antes desse prazo, mas em último caso, teria esperar o prazo oficial.</span>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-12">
                                 <h3><i class="gi gi-keys"></i> Dados da Conta</h3>'; 
                                 if(isset($_SESSION["MD10Alert"])){
                                    echo '<p style="text-align: center; color: red;">'.$_SESSION["MD10Alert"].'</p>';
                                    unset($_SESSION["MD10Alert"]);
                                 }
                              ...
                              <div class="col-md-4 col-md-offset-8 text-right">
                                 <div class="form-group">
                                    ...
                                    <a href="javascript:void(0);" onclick="if (!window.__cfRLUnblockHandlers) return false; aplicarCupom();" id="aplicarcupom" class="btn btn-default" data-cf-modified-ccb2ed1d7e003390d40b98f8-="">Aplicar</a>
                                    <a href="javascript:void(0);" onclick="if (!window.__cfRLUnblockHandlers) return false; removerCupom();" id="removercupom" class="btn btn-default hide" data-cf-modified-ccb2ed1d7e003390d40b98f8-="">Remover</a>
                              ...
                              <div class="col-md-12 text-right" style="margin: 20px 0;">
                                 ...
                                 <h4 style="margin: 0; text-decoration: line-through;" id="subtotal" class="hide" data-total="'.$_SESSION["MDPrice"].'">R$ 0</h4>
                                 <h1 style="margin: 0;" id="subtotaldesconto" data-total="'.$_SESSION["MDPrice"].'">R$ 0</h1>'; ?>
                                 </div>
                              </div>
         ...
         <script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="https://elojobhigh.com.br/app/assets/js/vendor/jquery.min.js" type="ccb2ed1d7e003390d40b98f8-text/javascript"></script>
         <script src="https://elojobhigh.com.br/app/assets/js/vendor/bootstrap.min.js" type="ccb2ed1d7e003390d40b98f8-text/javascript"></script>
         <script src="https://elojobhigh.com.br/app/assets/js/plugins.js" type="ccb2ed1d7e003390d40b98f8-text/javascript"></script>
         <script src="https://elojobhigh.com.br/app/assets/js/maskedinput.js" type="ccb2ed1d7e003390d40b98f8-text/javascript"></script>
         <script src="https://elojobhigh.com.br/app/assets/js/dinheiro.js" type="ccb2ed1d7e003390d40b98f8-text/javascript"></script>
         <script src="https://elojobhigh.com.br/app/assets/vex/js/vex.combined.min.js" type="ccb2ed1d7e003390d40b98f8-text/javascript"></script>
         <script src="https://elojobhigh.com.br/app/assets/select2/js/i18n/pt-BR.js" type="ccb2ed1d7e003390d40b98f8-text/javascript"></script>
         <script type="ccb2ed1d7e003390d40b98f8-text/javascript">
         ...
         <script src="https://elojobhigh.com.br/app/assets/js/app.js" type="ccb2ed1d7e003390d40b98f8-text/javascript"></script>
         <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="ccb2ed1d7e003390d40b98f8-|49" defer=""></script>
      </body>
   </html>