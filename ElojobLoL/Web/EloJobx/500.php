<head>
      ...
      <meta name="description" content="Preços baixos e segurança para você chegar no elo que merece! Elo Job (elojob), Elo Rocket (elorocket), Elo Boost, Coach e Duo Boost. Compre já!">
      ...
      <meta name="author" content="Elojob Brasil">
      <link rel="shortcut icon" href="favicon.ico">
      <title><?php echo name; ?> - Offline</title>
   </head>
    <style>
    h2 {
        color: #fff;
    ...
    <div id="hitarea">
            ...
            <h2>Erro 500 - Site fora do ar!</h2>