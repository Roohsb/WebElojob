...
export async function getServerSideProps(ctx) {
  ...
  const Orders = await LoggedAuthM.ordersLista(cookies._AuthorizationJobx)

  var Limite = L * 20
  var Limite2 = Limite - 20

  const Paginando = {status: true, page: L, count: Orders.Orders.length, Orders: Orders.Orders.slice(Limite2, Limite)}
   ...
   <div className="container-fluid">
    ...
    <div className="container-fluid mt--6">
        ...
        <div className="col">
          <div className="card bg-default shadow">
            <div className="card-header bg-transparent border-0">
              <h3 className="text-white mb-0">Lista de Todos os Pedidos</h3>
            </div>
              ...
              <table className="table align-items-center table-dark table-flush">
                <thead className="thead-dark">
                  <tr>
                    ...
                    <th scope="col" className="sort" data-sort="Booster">Booster</th>
                    <th scope="col" className="sort" data-sort="completion">Acoes</th>
                  </tr>
                </thead>
                <tbody className="list">
                {RenderCli.ordersList(cxt)}
                </tbody>
              </table>
            </div>
      ...
      {cxt.final.l.count > 20 ? <nav aria-label="Page navigation example">
       ...
       {Moree.paginationScr(cxt.final.l,"/development/orders/list")}
       </ul>
      </nav> : ''}
      ...
      <div className="modal fade" id="modal-default" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true">
        ...
        <div className="modal-content">
            ...
            <div className="modal-body">
                ...
                <p>Você deseja realmente apagar o PEDIDO <strong id="inseriridpedido">INSERIR PEDIDO</strong></p>
                <p>Ao continuar, você deve estar ciente que, <strong style={{color: 'red', fontSize: '13px'}}>NÃO SERA POSSÍVEL REVERTER ESTÁ AÇÃO</strong></p><p>Todos os dados do pedido serão apagados,(Partidas,Mensagens,Geral)</p>
            </div>
            <div className="modal-footer">
                <button onClick={(e) => LoggedAuthM.DeleteOrder(cxt.final.c._AuthorizationJobx)} type="button"  className="btn btn-primary">Continuar</button>
