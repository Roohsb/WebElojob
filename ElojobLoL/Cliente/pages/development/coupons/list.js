...
export async function getServerSideProps(ctx) {
  ...
  const Coupons = await LoggedAuthM.couponsLista(cookies._AuthorizationJobx)

  var Limite = L * 20
  var Limite2 = Limite - 20

  const Paginando = {status: true, page: L, count: Coupons.Coupons.length, Coupons: Coupons.Coupons.slice(Limite2, Limite)}
  ...
  return (
   ...
   <div className="container-fluid">
            ...
            <div className="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" className="d-none d-md-inline-block ml-md-4">
                <ol className="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li className="breadcrumb-item"><a href="#">Cupons</a></li>
    ...
    <div className="container-fluid mt--6">
        ...
        <div className="col">
          <div className="card bg-default shadow">
            <div className="card-header bg-transparent border-0">
              <h3 className="text-white mb-0">Lista de Cupons</h3>
            </div>
              ...
              <table className="table align-items-center table-dark table-flush">
                <thead className="thead-dark">
                  <tr>
                    ...
                    <th scope="col" className="sort" data-sort="name">Codigo</th>
                    <th scope="col" className="sort" data-sort="budget">Desconto</th>
                    <th scope="col" className="sort" data-sort="status">Data de Validade</th>
                    <th scope="col" className="sort" data-sort="completion">Acoes</th>
                  </tr>
                </thead>
                <tbody className="list">
                {RenderCli.couponsList(cxt.final.co.Coupons)}
                </tbody>
              </table>
            </div>
      ...
      {cxt.final.co.count > 20 ? <nav aria-label="Page navigation example">
       <ul className="pagination justify-content-center">
       {Moree.paginationScr(cxt.final.l,"/development/coupons/list")}
       </ul>
      </nav> : ''}
      {cxt.final.b === false ?
