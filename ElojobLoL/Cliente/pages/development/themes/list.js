...
export async function getServerSideProps(ctx) {
  ...
  const final = {
    ...
    b: boxAlert, 
    a: userDetails,
    l: await LoggedAuthM.temasLista(cookies._AuthorizationJobx)
    }
...
export default function ThemesList(cxt)
{
  return (
    <>
         ...
         <div className="card" style={{backgroundColor: 'rgb(248 249 254)'}}>
            <div className="card-header">
               <div className="row align-items-center">
                  <div className="col-8">
                     <h3 className="mb-0">Lista de Temas</h3>
                  </div>
               </div>
            </div>
            <div className="card-body">
                  ...
                  <div className="avatar-group">
                    {RenderCli.listthemes(cxt.final.l.themes)}
                      </div>
                  </div>
            </div>
         </div>
