...
<div className="container-fluid mt--6">
   ...
   <div className="row">
      <div className="col-xl-12 order-xl-2">
         ...
         <div className="header pb-6 d-flex align-items-center react" style={{minHeight: '300px',backgroundColor: '#0059FF',backgroundSize:'cover',backgroundPosition:'center top'}}>
            ...
            <div className="card-body pt-0">
               ...
               <div className="pl-lg-4"><div className="row">
                  ...
                  <input type="text" id="input-nome-theme" className="form-control" placeholder="Nome"/>
                  
                  </div>
                  </div>
                  <div className="col-lg-6"><div className="row">
                     <label className="form-control-label" for="input-email">Url (/Template/css/themes/VALUE.css)</label>
                     <input type="text" id="input-url-newtheme" className="form-control" placeholder="mytheme.css"/>
                     <span style={{fontSize: '12px'}}>Você precisa somente por o arquivo no site principal.</span>
                    
                     </div>
                     </div>
                   
                        <div className="col-lg-6"><div className="form-group"><label className="form-control-label" for="input-username">Cor de Referencia <a href="https://htmlcolorcodes.com" target="_blank" style={{fontSize: "12px"}}> Ver tabela de cores</a></label>
                        <input type="text" id="input-color-theme" className="form-control" placeholder="CODE COLOR" defaultValue='#0059FF'/>
                        </div>
                        </div>
                        <button type="button" className="btn btn-info" onClick={(e) => LoggedAuthM.preViewTheme(cxt.final.c._AuthorizationJobx)} style={{
                      width: '78px',
                      height: '45px',
                      fontSize: '10px',
                      textAlign: 'center',
                      top: '30px'}}>Previa</button>
                      </div>

                   
                     <button type="button" className="btn btn-success" onClick={(e) => LoggedAuthM.createTheme(cxt.final.c._AuthorizationJobx)}>Criar Tema</button>
