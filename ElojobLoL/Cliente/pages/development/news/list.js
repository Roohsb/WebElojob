...
export async function getServerSideProps(ctx) {
  ...
  const News = await LoggedAuthM.updatesLista(cookies._AuthorizationJobx)

  var Limite = L * 20
  var Limite2 = Limite - 20

  const Paginando = {status: true, page: L, count: News.News.length, News: News.News.slice(Limite2, Limite)}
  ...
  return (
   ...
   <div className="container-fluid">
    ...
    <div className="container-fluid mt--6">
        ...
        <div className="col">
          <div className="card bg-default shadow">
            <div className="card-header bg-transparent border-0">
              <h3 className="text-white mb-0">Lista de Noticias</h3>
            </div>
              ...
              <table className="table align-items-center table-dark table-flush">
                <thead className="thead-dark">
                  <tr>
                    ...
                    <th scope="col" className="sort" data-sort="name">Titulo</th>
                    <th scope="col" className="sort" data-sort="budget">Criador</th>
                    <th scope="col" className="sort" data-sort="status">Data</th>
                    <th scope="col" className="sort" data-sort="completion">Acoes</th>
                  </tr>
                </thead>
                <tbody className="list">
              {RenderCli.updatesList(cxt.final.u.News)}
                </tbody>
              </table>
            </div>
      ...
      {cxt.final.u.count > 20 ? <nav aria-label="Page navigation example">
       <ul className="pagination justify-content-center">
       {Moree.paginationScr(cxt.final.u,"/development/news/list")}
       </ul>
      </nav> : ''}
      {cxt.final.b === false ?
