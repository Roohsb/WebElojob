...
export async function getServerSideProps(ctx) {
  ...
  const avatar = typeof ctx.req.__NEXT_INIT_QUERY.avatar !== 'undefined' ? ctx.req.__NEXT_INIT_QUERY.avatar:  ctx.req.url.split("/")[4]

  const avatarDetails = await LoggedAuthM.avatarSearch(cookies._AuthorizationJobx,avatar)

  if(avatarDetails.status === false){

   ctx.res.writeHead(302, { Location: '/development/avatares/list' });
   ctx.res.end();
   return {
     props: {
       cookies,
...
<div className="container-fluid mt--6">
         ...
         <div className="header pb-6 d-flex align-items-center" style={{minHeight: '300px',backgroundImage: 'url(/lol/wallpapers/Jinx.jpg)',backgroundSize:'cover',backgroundPposition:'center top'}}>
            ...
            <div className="row justify-content-center">
               <div className="col-lg-3 order-lg-2">
                  <div className="card-profile-image">
                     <a href="#">
                     <img src={"/lol/profiles/avatar/"+cxt.final.ad.Avatar[0].img} className="rounded-circle" style={{width: '240px', maxWidth: '240px'}}/>
                     </a>
                  </div>
               </div>
            </div>
            ...
            <div className="card-body pt-0">
               <div className="row">
                  <div className="col">
                     <div className="card-profile-stats d-flex justify-content-center">
                        <div>
                           <span className="heading">{cxt.final.ad.Avatar[0].name}</span>
                           <span className="description">Nome</span>
                        </div>
                        <div>
                           <span className="heading">{cxt.final.ad.Avatar[0].id}</span>
               ...
               <div className="pl-lg-4"><div className="row">
                  ...
                  <input type="text" id="input-nome-avatar" className="form-control" defaultValue={cxt.final.ad.Avatar[0].name} placeholder="Nome"/>
                  
                  </div>
                  </div>
                  <div className="col-lg-6"><div className="form-group">
                     <label className="form-control-label" for="input-email">ID</label>
                     <input type="email" id="input-id-avatar" className="form-control" defaultValue={cxt.final.ad.Avatar[0].id} placeholder="id" disabled/>
                     ...
                     <div className="row">
                        <div className="col-lg-10">
                           ...
                           <label className="form-control-label" for="input-first-name">Url (/lol/profiles/avatar/VALUE)</label>
                           <input type="text" id="input-url-avatar" defaultValue={cxt.final.ad.Avatar[0].img} className="form-control" placeholder="image.jpg"/>
                              </div>
                           </div>
                     </div>
                     <button type="button" className="btn btn-success" onClick={(e) => LoggedAuthM.atualizarAvatar(cxt.final.c._AuthorizationJobx)}>Salvar Alterações</button>
                     <button type="button" className="btn btn-danger"  data-toggle="modal" data-target="#modal-delete-avatar">Apagar Avatar</button>
   ...
   <div className="modal fade" id="modal-delete-avatar" tabindex="-1" role="dialog" aria-labelledby="modal-delete-avatar" aria-hidden="true">
        ...
        <div className="modal-content">
            ...
            <div className="modal-body">
                ...
                <p>Você deseja realmente apagar o avatar <strong id="inserirusername">{cxt.final.ad.Avatar[0].name}</strong></p>
            ...
            <div className="modal-footer">
                <button onClick={(e) => LoggedAuthM.deleteAvatar(cxt.final.c._AuthorizationJobx,cxt.final.ad.Avatar[0].id)} type="button"  className="btn btn-primary">Continuar</button>
