...
export async function getServerSideProps(ctx) {
  ...
  const userDetails = await LoggedAuth.Details(
    ...
    const Customers = await LoggedAuth.ClientAwait(cookies._AuthorizationJobx)

    var Limite = L * 20
    var Limite2 = Limite - 20

    const Paginando = {status: true, page: L, count: Customers.compras.length, compras: Customers.compras.slice(Limite2, Limite)}
            ...
            <div className="col-lg-6 col-7">
              ...
              <nav aria-label="breadcrumb" className="d-none d-md-inline-block ml-md-4">
                <ol className="breadcrumb breadcrumb-links breadcrumb-dark">
                  ...
                  <li className="breadcrumb-item active" aria-current="page">Disponiveis</li>
                </ol>
              </nav>
            </div>
          ...
          <div className="card bg-default shadow">
            ...
            <div className="table-responsive">
              <table className="table align-items-center table-dark table-flush">
               ...
               {RenderCli.clientsAllAwait(cxt.final.ca.compras)}
                </tbody>
              </table>
            </div>
