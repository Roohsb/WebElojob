...
<div className="container-fluid">
    <div className="row flex-xl-nowrap">
      ...
      <main className="col-12 col-md-8 col-xl-7 py-md-3 pl-md-5 ct-content" role="main">
        ...
        <p className="ct-lead">
        Abaixo você saberá como adicionar um avatar no site corretamente.
        </p>
        <hr/>
        ...
        <video _ngcontent-wwx-c41="" width="907" height="478"  tabIndex="0" preload="metadata" role="video" autoPlay={true} loop={true} muted={true}>
          <source src="/docs/movies/avatar-add.mp4" type="video/mp4"/>
          </video>
          <p className="ct-lead" style={{color: "orange"}}>
          * Exemplo de como adicionar um avatar.
        </p>
        ...
        <h2 id="tutorial">Tutorial</h2>
          <p>Você precisa ir em <a href="/development/avatares/add" target="_blank">Adicionar Avatar</a> Em,  <strong style={{color: "orange"}}>Nome</strong> Defina o nome do avatar, em <strong style={{color: "orange"}}>Url (/lol/profiles/avatar/VALUE)</strong> Defina o arquivo, exemplo:<strong style={{color: "orange"}}> imagem.png</strong><br/></p><br/>
          <p>Lembrando, você deve por a imagem nos 2 diretorios dos sites</p>
          <ul>
            <li>DashBoard: <strong style={{color: "orange"}}>Dashboard/template/lol/profiles/avatar/</strong></li>
            <li>Elo: <strong style={{color: "orange"}}>Elo/Template/imagens/profiles/avatar/</strong></li>
          </ul>
